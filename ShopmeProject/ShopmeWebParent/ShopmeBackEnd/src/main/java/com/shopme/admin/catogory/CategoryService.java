package com.shopme.admin.catogory;
...
public class CategoryService {
	...
	public void listSubHierarchicalCategories(List<Category> hierarchiCategories,
		...
		for(Category subCategory : children) {
			...
			listSubHierarchicalCategories(hierarchiCategories, subCategory, newSubLevel, sortDir);
		}
	}
